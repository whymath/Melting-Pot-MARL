...
if __name__ == "__main__":
  ...
  results_timestep = results[1]
  results_final.to_csv(f'{args.config_dir}/results_evals.csv',index=False)
  results_timestep.to_csv(f'{args.config_dir}/results_timestep_evals.csv',index=False)
