...
def get_cli_args():
  ...
  parser.add_argument(
      "--exp",
      type=str,
      choices = ['pd_arena','al_harvest','clean_up','territory_rooms','day_care','commons_harvest__partnership','commons_harvest__open','commons_harvest__private_property_pc','commons_harvest__private_property','commons_harvest__open_disable_zapping','commons_harvest__closed','commons_harvest__farmer'],
      default="pd_arena",
